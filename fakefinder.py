...
def draw_bboxes(image_tensor_u8, boxes, labels, bbox_colors, bbox_width=6, font_size=58, text_offset=14, stroke_width=0):
...
def predict_and_draw_gradcam_bbox(model, image_path, device, class_names, keep_top=0.15, alpha=0.8, gamma=2.2, real_threshold=None, fake_threshold=None):
    """
    ...
    Args:
        ...
        class_names: Liste des noms de classes (ex: ['fake', 'real'])
...
### Pour faire des prédictions : Charge le modèle entraîné depuis le fichier sauvegardé
...
# image_path = './AIvsReal_sampled/test/real/0201.jpg' ### Ajoutez le chemin de votre image ici
image_path = './images/real/IMG_6693.jpg' ### Ajoutez le chemin de votre image ici
class_names = val_dataset.classes

# Visualise les prédictions faites par le modèle entraîné
_ = predict_and_draw_gradcam_bbox(trained_model, image_path, DEVICE, class_names)
